...
public class test{
	...
	static ParticleGravity poids = new ParticleGravity(new Apoint(0,4,0));
	...
	public static void simulate(double dt,int niter){
		...
		if(niter==350){
			listOfParticles.get(0).velocity = Apoint.multByScalar(listOfParticles.get(0).velocity,70/7);
		}
...
if(listOfParticles.size()>=29){
	...
	public static void main(String [] args){
		listOfParticles.add(new Particle(new Apoint(0,0.8*800,0),0.01,Apoint.multByScalar(Apoint.normalize(new Apoint(1000,0.8*800-30,0)),7),Color.black,6));
